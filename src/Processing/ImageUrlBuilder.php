...
final class ImageUrlBuilder
{
    ...
    public function waterImg(
        ...
        $waterStr = 'watermark/1/image/' . $func->base64_urlSafeEncode($image) . '/';
    ...
    public function waterText(
        ...
        $waterStr = 'watermark/2/text/'
            . $func->base64_urlSafeEncode($text) . '/font/'
            . $func->base64_urlSafeEncode($font) . '/';
        ...
        if (! is_null($fontColor)
            ...
            $waterStr .= 'fill/' . $func->base64_urlSafeEncode($fontColor) . '/';
        }
