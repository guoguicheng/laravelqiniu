...
final class BucketManager
{
    ...
    {
        $func=new Qiniu\Functions();
        $query = array('bucket' => $bucket);
        $func->setWithoutEmpty($query, 'prefix', $prefix);
        $func->setWithoutEmpty($query, 'marker', $marker);
        $func->setWithoutEmpty($query, 'limit', $limit);
        $func->setWithoutEmpty($query, 'delimiter', $delimiter);
    ...
    {
        $func=new Qiniu\Functions();
        $path = '/stat/' . $func->entry($bucket, $key);
    ...
    {
        $func=new Qiniu\Functions();
        $path = '/delete/' . $func->entry($bucket, $key);
    ...
    private static function oneKeyBatch($operation, $bucket, $keys)
    {
        ...
        $func=new Qiniu\Functions();
        foreach ($keys as $key) {
            array_push($data, $operation . '/' . $func->entry($bucket, $key));
        }
        return $data;
    }
